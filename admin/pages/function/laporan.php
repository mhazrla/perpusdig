...
if ($_GET['action'] == "tgl_peminjaman") {
    ...
    echo "<p style='font-size: 12px;' class='text-center'> Jakarta Timur <br> Email : perpusdig@gmail.com | Nomor Telpon : 02123322 </p>";
    echo "<hr>";
    ...
    echo "</tr>";
    $no = 1;
    $sql = mysqli_query($conn, "SELECT * FROM peminjaman WHERE tgl_peminjaman = '$tgl_peminjaman'");
    ...
    echo "</table>";
    echo "<p style='text-align: center;'>Laporan Perpustakaan Berdasarkan Tanggal Peminjaman (" . $_POST['tgl_peminjaman'] . ")</p>";
    ...
    echo "</body>";
    echo "</html>";
} elseif ($_GET['action'] == "tgl_pengembalian") {
    ...
    echo "<img src='../../../../assets/dist/img/LOGO-PERPUSNAS.png' style='display: block; margin-left: auto; width: 90px; margin-bottom: -70px; margin-top: -38px; margin-right: 5px;'>";
    echo "<h3 class='text-center' style='font-family: Quicksand, sans-serif; margin-top: -30px;'>.:: Laporan Perpustakaan ::.</h3>";
    $sql2 = mysqli_query($conn, "SELECT * FROM identitas");
    ...
    echo "</tr>";
    $no = 1;
    $sql = mysqli_query($conn, "SELECT * FROM peminjaman WHERE tgl_pengembalian = '$tgl_pengembalian'");
    while ($row = mysqli_fetch_assoc($sql)) {
        echo "<tbody>";
        echo "<tr>";
        echo "<td>" . $no++ . "</td>";
    ...
    echo "</body>";
    echo "</html>";
} elseif ($_GET['action'] == "nama_anggota") {
    ...
    echo "</tr>";
    $no = 1;
    $sql = mysqli_query($conn, "SELECT * FROM peminjaman WHERE nama_anggota = '$nama_anggota'");
    while ($row = mysqli_fetch_assoc($sql)) {
        echo "<tbody>";
        echo "<tr>";
        echo "<td>" . $no++ . "</td>";
